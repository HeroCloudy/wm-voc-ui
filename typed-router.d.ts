...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/manage': RouteRecordInfo<'/manage', '/manage', Record<never, never>, Record<never, never>, '/manage/components/question-card' | '/manage/list' | '/manage/star' | '/manage/trash'>,
    '/manage/components/question-card': RouteRecordInfo<'/manage/components/question-card', '/manage/components/question-card', Record<never, never>, Record<never, never>>,
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/manage.vue': {
      routes: '/manage' | '/manage/components' | '/manage/list' | '/manage/components/question-card' | '/manage/star' | '/manage/trash'
      views: 'default'
    }
    'src/pages/manage/components/question-card.vue': {
      routes: '/manage/components/question-card'
      views: never
    }
