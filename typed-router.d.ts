...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/detail': RouteRecordInfo<'/detail', '/detail', Record<never, never>, Record<never, never>, '/detail/edit' | '/detail/edit/[:id]' | '/detail/edit/components/editor-canvas' | '/detail/stat' | '/detail/stat/[:id]'>,
    '/detail/edit': RouteRecordInfo<'/detail/edit', '/detail/edit', Record<never, never>, Record<never, never>, '/detail/edit/[:id]' | '/detail/edit/components/editor-canvas'>,
    '/detail/edit/[:id]': RouteRecordInfo<'/detail/edit/[:id]', '/detail/edit/::id', { :id: ParamValue<true> }, { :id: ParamValue<false> }>,
    '/detail/edit/components/editor-canvas': RouteRecordInfo<'/detail/edit/components/editor-canvas', '/detail/edit/components/editor-canvas', Record<never, never>, Record<never, never>>,
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/detail.vue': {
      routes: '/detail' | '/detail/edit/[:id]' | '/detail/stat/[:id]' | '/detail/edit/components' | '/detail/edit' | '/detail/edit/components/editor-canvas' | '/detail/stat'
      views: 'default'
    }
    'src/pages/detail/edit.vue': {
      routes: '/detail/edit' | '/detail/edit/[:id]' | '/detail/edit/components' | '/detail/edit/components/editor-canvas'
      views: 'default'
    }
    ...
    'src/pages/detail/edit/components/editor-canvas.vue': {
      routes: '/detail/edit/components/editor-canvas'
      views: never
    }
